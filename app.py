...
def load_data():
    df= pd.read_csv(r'C:\Users\DELL\Desktop\Stock Market Analysis project\AAPL (4).csv', parse_dates= ['Date'], dayfirst= False) 
...
# Load ARIMA model
def load_model():
    return joblib.load(r'C:\Users\DELL\Desktop\Stock Market Analysis project\github\arima_final_model.pkl')
